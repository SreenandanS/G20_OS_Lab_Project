...
![Signal Demo](screenshots/project1/signaldemo.png)

### Clone and Join Demonstration

![Thread Demo](screenshots/project1/threadtest.png)

### Mailbox IPC Demonstration

![IPC Demo](screenshots/project1/ipc_demo.png)

### Semaphore Demonstration

![Semaphore Demo](screenshots/project1/semdemo.png)

### Priority Control Demonstration

![Priority Demo](screenshots/project1/prioritydemo.png)

### Runtime Accounting with `waitx`

![waitx Demo](screenshots/project1/test_waitx.png)

### Process Table Snapshot with `getpinfo`

![getpinfo Demo](screenshots/project1/getpinfo_test.png)
